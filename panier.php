...
<button name='button'class="bouton"> Vider panier </button></form>
</div>
<div id="d6">
...
if (isset($_POST['sub'])){
  ...
  unset($_SESSION['panier']['nom'][$_POST['hid']]);

  unset($_SESSION['panier']['quantite'][$_POST['hid']]);
  unset($_SESSION['panier']['prix'][$_POST['hid']]);
