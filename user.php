...
<img id='iga' src='iga.jpg'><button id="btn1" type="button" >        <i class="fa fa-shopping-cart"></i>  </button> </h1>  <br > <HR>
    ...
    <h3 id="h3"> MON COMPTE </h3>
       <p class="p2">Chez IGA.Net, nous révisons et améliorons sans cesse nos mesures de sécurité afin de protéger les renseignements personnels de nos clients. Par excès de prudence, nous avons récemment renforcé la sécurité sur notre site. Nos clients devrons donc modifier leur mot de passe afin d’accéder à leur compte.</p>
