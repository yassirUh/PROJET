...
$sql = "SELECT * FROM users where  Courriel='".$_POST['couriel']."'";
$sql2 = mysqli_query($conn,$sql);
$sql3 = mysqli_num_rows($sql2);
if ($sql3 > 0){
    $_SESSION["courriel"]= $_POST['couriel'];
...
<img id='iga' src='iga.jpg'><button id="btn1" type="button" >        <i class="fa fa-shopping-cart"></i>  </button> </h1>  <br > <HR>
    ...
    <h3 id="h3"> RÉINITIALISER VOTRE MOT DE PASSE </h3>
       ...
       <p class="p3">Courriel :</p>
        <form action="forget.php" method="POST">
       <input  class="input"type="text" name="couriel"> <br><br><br>
